			...
			<div class="container-fluid">
				...
				<?php
                             if (has_nav_menu('primary')) {
							     wp_nav_menu([
								'menu'              => 'primary', //Меню которое нужно вывести
								'theme_location'    => 'primary',
								'container'         => 'div', //Чем оборачивать ul тег. Допустимо: div или nav.
								'container_class'   => 'collapse navbar-collapse',//Значение атрибута class у контейнера меню.
								'container_id'      => 'navbars-host',//Значение атрибута id у контейнера меню.
								'menu_class'        => 'navbar-nav ml-auto',//Значение атрибута class у тега ul.
								'fallback_cb'       => false,
								'depth'             => 0,
								// 'walker'            => new Walker() // Use different Walker
								]);
                            }; ?>
